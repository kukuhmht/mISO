...
Class Index extends CI_Controller {
  ...
  parent:: __construct();
	$this->load->model('login_kepala_sekolah_model/index_model');
  }
	...
	public function index() {
		...
		$data['title']	= 'Masuk sebagai Kepala Sekolah';

		$this->load->view('login_kepala_sekolah/index',$data);
	}
	...
	public function signin() {
		...
		if(is_null($data[0]['username'])){
			...
			redirect('login_kepala_sekolah/index');
		}else if($username == $data[0]['username'] && $password == $data[0]['password'] && ($data[0]['id_hakakses'] == "4")){
			$data_session = array(
