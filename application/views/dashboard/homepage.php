...
<div class="parallax-container center valign-wrapper" style="margin-top:-47px;">
	<div class="row">
	  ...
	  <div class="col s12 m10 center white-text">
		<h2 class="white-text lighten-2 animated zoomIn" style="font-family:Calibri Light (Headings);font-weight:299;">mudahkan pengiriman dokumen, mudahkan setiap laporan</h2>
		<a href="<?php echo base_url('dashboard/home');?>" class="waves-effect waves-light btn-large blue animated fadeInUp">Kunjungi mISO</a>
	  </div>
	  <div class="col s12 m1"></div>
	</div>
...
<div class="parallax-container center valign-wrapper">
  <div class="parallax"><img src="<?php echo base_url('assets/images/bg11.jpg'); ?>">
  </div>
</div>
...
<div class="parallax-container center valign-wrapper">
  <div class="parallax"><img src="<?php echo base_url('assets/images/bg10.jpg'); ?>">
  </div>
</div>
