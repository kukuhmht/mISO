        ...
        <div class="col s12">
          ...
          <ul id="nav-mobile" class="right hide-on-med-and-down">
            ...
            <li>
              ...
              <form action="<?php echo base_url('kepala_sekolah/home');?>" method="post" style="height:64px;">
                <div class="input-field">
                  <input id="search" name="search" type="search" placeholder="Cari Dokumen">
...
<!-- Filter Tanggal WMM -->
  <div id="filterwmm" class="modal bottom-sheet">
   <form action="<?php echo base_url('kepala_sekolah/home/filter');?>" method="post">
