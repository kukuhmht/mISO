...
<div class="row">
	<div class="col s12">
		<div class="card col s5 blue">
		  ...
		  <center>
			<a href="<?php echo base_url('unit_kerja/home/kirim_dokumen/'.$id_dokumen);?>" class="btn green waves-effect waves-light"> Ya, Kirim </a>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="<?php echo base_url('unit_kerja/upload_dokumen/edit/'.$id_dokumen); ?>" class="btn red waves-effect waves-light"> Tidak, Edit </a>
			<br>
			<br>
		  </center>
		</div>
