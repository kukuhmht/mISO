...
<div class="navbar-upper">
  <nav class="z-depth-0">
    <div class="nav-wrapper blue lighten-1">
      <div class="row">
        <div class="col s12">
          <a href="<?php echo base_url('unit_kerja/home');?>" class="brand-logo" style="display:block;float:left;"><?php echo $title ?></a>
          <ul id="nav-mobile" class="right hide-on-med-and-down">
            
            <li>
              
              <form action="<?php echo base_url('unit_kerja/home/search');?>" method="post" style="height:64px;">
                <div class="input-field">
                  <input id="search" type="search" required placeholder="Search Dokumen">
...
<div class="row">  
  ...
  <div class="col s12 center">
    ...
    <br>
      ...
      <h5>Dokumen Tidak di Temukan</h5><br>
    <br>
    <br>
    <br>
    <br>
...
<div class="row">
  ...
  <div class="col s12 center">
    ...
    <br>
      <i class="material-icons large blue-text">search</i><br>
      <h5>Dokumen Revisi Tidak di Temukan</h5>
    <br>
    <br>
    <br>
    <br>
