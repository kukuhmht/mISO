...
<div class="navbar-upper">
  <nav class="z-depth-0">
    <div class="nav-wrapper blue lighten-1">
      <div class="row">
        <div class="col s12">
          <a href="<?php echo base_url('unit_kerja/home');?>" class="brand-logo" style="display:block;float:left;"><i class="material-icons">arrow_back</i> <?php echo $title ?> <?php echo $nama_dokumen ?></a>
        </div>
      </div>
    </div>
  </nav>
				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							if($jenis_pos == '')
							{
								echo "<span style='font-size:12px;'>tidak ada Jenis POS</span>";
							}
							?>
						</td>
					</tr>
		...
		<div class="card col s12">
			<table>
				<tbody>
					<tr>
						<td>
							<span class="grey-text"> Pesan dari WMM <br></span>
							<span style='font-size:13px;'><?php echo $pesan ?></span> 
							<?php
							if($pesan == '')
							{
								echo "<span style='font-size:12px;'>tidak ada pesan</span>";
							}
							?>
						</td>
					</tr>
