...
<div class="row">
	...
	<div class="col s12 m9 right">
		<div class="card">
		  ...
		  <div class="col s10">
			...
			<div class="card col s12">
			  ...
			  <span>
				...
				if($tempat_revisi == '')
				{
					echo "<span class='grey-text' style='font-size:12px;'> tidak ada tempat yang akan di revisi </span>";
				}
				?>
			  </span>
			</div>
		  ...
		  <div class="col s6">
			...
			<div class="card col s12">
			  ...
			  <span> 
				...
				if($semula_berbunyi == '')
				{
					echo "<span class='grey-text' style='font-size:12px;'> tidak ada usulan </span>";
				}
				?>
			  </span>
			</div>
		  ...
		  <div class="col s8">
			...
			<div class="card col s12">
			  ...
			  <span>
				...
				if($alasan_usulan == '')
				{
					echo "<span class='grey-text' style='font-size:12px;'> tidak ada alasan </span>";
				}
				?>
			  </span>
			</div>
		  ...
		  <div class="col s4 right">
			...
			<div class="card col s12">
			  ...
			  <span>
				...
				{
					echo "<span class='grey-text' style='font-size:12px;'> belum disetujui </span>";
				}
				?>
			  </span>
			</div>
		  ...
		  <div class="col s4">
			...
			<div class="card col s12">
			  ...
			  <span>
				...
				if($tgl_persetujuan == '')
				{
					echo "<span class='grey-text' style='font-size:12px;'> belum di setujui </span>";
				}
				?>
			  </span>
			</div>
		  ...
		  <div class="col s5">
			<span class="grey-text">Pesan dari WMM</span><br>
			<div class="card col s12">
			  <span> <?php echo $pesan_revisi ?> </span>
			  <?php
				if($pesan_revisi == '')
				{
					echo "<span class='grey-text' style='font-size:12px;'> tidak ada pesan </span>";
				}
				?>
			</div>
		  </div>
