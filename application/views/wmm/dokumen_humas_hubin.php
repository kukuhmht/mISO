...
<div class="row" style="margin-top:-25px;">
  <div class="col s12">
	<?php foreach($list_dokumen_humas_hubin as $row) { ?>
  ...
  <?php if(count($list_dokumen_humas_hubin) == 0) { ?>
  <div class="col s12 center">
    ...
    <br>
      ...
      <h5>Belum ada Dokumen yang di Upload oleh Unit Kerja Bidang Humas dan Hubin</h5><br>
    <br>
    <br>
    <br>
    <br>
