...
<div class="row" style="margin-top:-25px;">
  <div class="col s12">
	<?php foreach($list_dokumen_mm as $row) { ?>
  ...
  <?php if(count($list_dokumen_mm) == 0) { ?>
  <div class="col s12 center">
    ...
    <br>
      ...
      <h5>Belum ada Dokumen yang di Upload oleh Unit Kerja Kompetensi Keahlian Multimedia</h5><br>
    <br>
    <br>
    <br>
    <br>
