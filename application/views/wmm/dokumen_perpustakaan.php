...
<div class="row" style="margin-top:-25px;">
  <div class="col s12">
	<?php foreach($list_dokumen_perpustakaan as $row) { ?>
  ...
  <?php if(count($list_dokumen_perpustakaan) == 0) { ?>
  <div class="col s12 center">
    ...
    <br>
      ...
      <h5>Belum ada Dokumen yang di Upload oleh Unit Kerja Perpustakaan </h5><br>
    <br>
    <br>
    <br>
    <br>
