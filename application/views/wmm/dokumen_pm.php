...
<div class="row" style="margin-top:-25px;">
  <div class="col s12">
	<?php foreach($list_dokumen_pm as $row) { ?>
  ...
  <?php if(count($list_dokumen_pm) == 0) { ?>
  <div class="col s12 center">
    ...
    <br>
      ...
      <h5>Belum ada Dokumen yang di Upload oleh Unit Kerja Kompetensi Keahlian Administrasi Pemasaran </h5><br>
    <br>
    <br>
    <br>
    <br>
