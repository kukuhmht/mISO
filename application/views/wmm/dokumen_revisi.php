        ...
        <div class="col s12">
          ...
          <ul id="nav-mobile" class="right hide-on-med-and-down">
            ...
            <li>
              ...
              <form action="<?php echo base_url('wmm/dokumen/dokumen_revisi');?>" method="post" style="height:64px;">
                <div class="input-field">
                  <input id="search" name="search" type="search" placeholder="Cari Dokumen Revisi">
...
<div class="row" style="margin-top:-25px;">
  ...
  <div class="col s12 center">
    ...
    <br>
      ...
      <h5>Belum ada Dokumen yang di Revisi oleh Unit Kerja</h5><br>
    <br>
    <br>
    <br>
    <br>
...
<!-- Filter Tanggal WMM -->
  <div id="filterwmm" class="modal bottom-sheet">
   <form action="<?php echo base_url('wmm/home/filter_revisi');?>" method="post">
		...
		<ul class="collection">
		  <li class="collection-item">
		   <div class="col s4">
			...
			<select required id="tgl" name="tgl" class="browser-default validate">
			 <?php foreach($ambil_bulanrevisi as $row) { ?>
			  <option value="<?php echo $row->tgl_id ?>"> <?php echo $row->tgl ?> </option>
			  <option disabled> Bulan disini hanya tersedia jika ada Dokumen Revisi di bulan tersebut </option>
			 <?php } ?>
			 <?php if(count($ambil_bulanrevisi) == 0) { ?>
			  <option> tidak tersedia, karena tidak ada dokumen revisi yang dikirim </option>
			 <?php } ?>
			</select>
		   </div>
		  </li>
		  <li class="collection-item">
			...
			<select required id="tahun" name="tahun" class="browser-default validate">
			 <?php foreach($ambil_tahunrevisi as $row) { ?>
			  <option value="<?php echo $row->tahun ?>"> <?php echo $row->tahun ?> </option>
			  <option disabled> Tahun disini hanya tersedia jika ada Dokumen Revisi di tahun tersebut </option>
			 <?php } ?>
			 <?php if(count($ambil_tahunrevisi) == 0) { ?>
			  <option> tidak tersedia, karena tidak ada dokumen revisi yang dikirim </option>
			 <?php } ?>
			</select>
		  </li>
