...
-Kukuh M HidayaTullah (15 April 2018)
        ...
        <div class="col s12">
          ...
          <ul id="nav-mobile" class="right hide-on-med-and-down">
            ...
            <li>
              ...
              <form action="<?php echo base_url('wmm/home');?>" method="post" style="height:64px;">
                <div class="input-field">
                  <input id="search" name="search" type="search" placeholder="Cari Dokumen WMM">
            ...
            <li><a href="#notifikasi" class="waves-effect waves-light modal-trigger tooltipped" data-position="bottom" data-delay="50" data-tooltip="Notifikasi"><i class="material-icons">notifications</i></a></li>
...
<div class="row" style="margin-top:-25px;">
  <div class="col s12">
	<?php foreach($list_dokumen_wmm as $row) { ?>
  ...
  <?php if(count($list_dokumen_wmm) == 0) { ?>
  <div class="col s12 grey lighten-2 center">
    ...
    <br>
	  ...
	  <span>Upload Dokumen <a href="<?php echo base_url('wmm/upload_dokumen')?>" class="btn blue waves-effect waves-light">Baru</a></span>
    <br>
    <br>
    <br>
    <br>
...
<!-- Filter Tanggal WMM -->
  <div id="filterwmm" class="modal bottom-sheet">
   <form action="<?php echo base_url('wmm/home/filter_wmm');?>" method="post">
		  ...
		  <li class="collection-item">
		   <div class="col s4">
			...
			<select required id="tgl" name="tgl" class="browser-default validate">
			 <?php foreach($ambil_bulanwmm as $row) { ?>
