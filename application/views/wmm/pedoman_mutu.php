      ...
      <div class="row">
        <div class="col s12">
          ...
          <ul id="nav-mobile" class="right hide-on-med-and-down">
			...
			<li><a class="waves-effect waves-light blue" style="font-size:20px;font-family:Calibri Light (Headings);font-weight:300" href="<?php echo base_url('wmm/pedoman_mutu'); ?>">Pedoman Mutu</a></li>
...
<div class="row" style="margin-top:-25px;">
  <div class="col s12">
	<?php foreach($list_pedoman_mutu as $row) { ?>
		...
		<div class="card hoverable">
			<div class="card-image">
				...
				<?php if(empty($row->tgl_dikirim)==true) { ?>
				  <a href="<?php echo base_url('wmm/pedoman_mutu/edit/'.$row->id_pedomanmutu); ?>" class="btn-floating halfway-fab waves-effect waves-light green"><i class="material-icons">edit</i></a>
				<?php }else { ?>
				...
				<?php } ?>
				<?php if(empty($row->tgl_dikirim)==true) { ?>
				  <a href="<?php echo base_url('wmm/pedoman_mutu/hapus/'.$row->id_pedomanmutu); ?>" onclick="return confirm('Apakah anda yakin ingin menghapus?')" class="btn-floating halfway-fab waves-effect waves-light red left"><i class="material-icons">delete</i></a>
				<?php }else { ?>
			...
			<div class="card-content">
			 ...
			 <?php if(empty($row->tgl_dikirim)==true) { ?>
			  <a href="<?php echo base_url('wmm/pedoman_mutu/view_kirim_dokumen/'.$row->id_pedomanmutu); ?>" class="waves-effect waves-light btn red lighten-1 right"> kirim </a>
			 <?php }else { ?>
				...
				<table class="bordered">
					<tbody>
						...
						<tr>
							...
							<td>
								<span class="grey-text" style="font-size:12px;"> <b><?php echo $row->status_dokumen ?></b> </span>
								<?php
								if($row->status_dokumen == '')
								{
									echo "<span class='grey-text' style='font-size:12px;'> <b>tidak ada status</b> </span>";
								}
								?>
							</td>
						</tr>
  ...
  <?php if(count($list_pedoman_mutu) == 0) { ?>
  <div class="col s12 center">
    ...
    <br>
      ...
      <h5>Belum ada Pedoman Mutu yang di Upload</h5><br>
	  <span>Upload Pedoman Mutu &nbsp;&nbsp; <a href="<?php echo base_url('wmm/pedoman_mutu/upload')?>" class="btn blue waves-effect waves-light">Baru</a></span>
    <br>
    <br>
    <br>
    <br>
