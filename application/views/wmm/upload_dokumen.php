...
<br>
<div class="container">
<form action="<?php echo base_url('wmm/upload_dokumen/tambah');?>" method="post">
<div class="row">
	<div class="col s12">
	  <div class="col s12">
		<div class="input-field col s7">
		  <input required id="nama_dokumen" name="nama_dokumen" type="text" class="validate" />
	  ...
	  <div class="col s12">
		<center>
		  <a href="https://drive.google.com/drive/folders/1FSfSprjL7KAIDEFoIS_1eWHnkUQ66TLL?usp=sharing" target="_blank" class="btn-large waves-effect waves-light blue">upload dokumen via Google Drive <i class="material-icons" style="font-size:15px;">open_in_new</i></a>&nbsp;&nbsp;&nbsp;
		  <a href="#about_google_drive" class="modal-trigger"><i class="material-icons grey-text">help</i></a>
		</center>
		<div class="input-field col s12">
		  <input required id="dokumen_path" name="dokumen_path" type="text" placeholder="Contoh URL: https://drive.google.com/file/d/0BxuiQ-cxi2TYY2FYNjl0TE44dmM/preview" />
