...
/*!50003 DROP TRIGGER*//*!50032 IF EXISTS */ /*!50003 `sianitahanwaeanjing` */$$

/*!50003 CREATE */ /*!50017 DEFINER = 'root'@'localhost' */ /*!50003 TRIGGER `sianitahanwaeanjing` BEFORE UPDATE ON `dokumen` FOR EACH ROW BEGIN
