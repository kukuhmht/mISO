...
CREATE TABLE `pedoman_mutu` (
  ...
  KEY `id_user` (`id_user`),
  CONSTRAINT `pedoman_mutu_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

/*Data for the table `pedoman_mutu` */

insert  into `pedoman_mutu`(`id_pedomanmutu`,`id_user`,`nama_dokumen`,`dokumen_path`,`tgl_upload`,`tgl_dikirim`,`status_dokumen`,`catatan`) values 
...
(5,'Rekayasa Perangkat Lunak','fahr','mz',2);
