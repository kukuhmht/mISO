...
CREATE TABLE `pedoman_mutu` (
  ...
  KEY `id_unit` (`id_unit`),
  CONSTRAINT `pedoman_mutu_ibfk_1` FOREIGN KEY (`id_unit`) REFERENCES `unit_kerja` (`id_unit`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

/*Data for the table `pedoman_mutu` */

insert  into `pedoman_mutu`(`id_pedomanmutu`,`id_unit`,`nama_dokumen`,`dokumen_path`,`tgl_upload`,`tgl_dikirim`,`status_dokumen`,`catatan`) values 
(1,2,'Pedoman Mutu ISO 9001:2015','https://drive.google.com/file/d/0BxuiQ-cxi2TYY2FYNjl0TE44dmM/preview','2018-04-04 17:49:33',NULL,NULL,'ini Pedoman Mutu khusus ISO 9001:2015');
...
CREATE TABLE `unit_kerja` (
  ...
  PRIMARY KEY (`id_unit`),
  KEY `id_user` (`id_user`),
  CONSTRAINT `unit_kerja_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=latin1;

/*Data for the table `unit_kerja` */

insert  into `unit_kerja`(`id_unit`,`id_user`,`nama_unit`) values 
(1,NULL,'Humas dan Hubin'),
(2,NULL,'Kesiswaan'),
(3,NULL,'Kurikulum'),
(4,NULL,'Penelitian dan Pengembangan'),
(5,NULL,'Sarana dan Prasaran'),
(6,NULL,'Sumber Daya Manusia'),
(7,NULL,'Administrasi Perkantoran'),
(8,NULL,'Administrasi Akuntansi'),
(9,NULL,'Administrasi Pemasaran'),
(10,NULL,'Multimedia'),
(11,NULL,'TKJ'),
(12,NULL,'RPL'),
(13,NULL,'ICT'),
(14,NULL,'Bimbingan Konseling'),
(15,NULL,'Lingkungan Hidup'),
(16,NULL,'Perpustakaan'),
(17,NULL,'Tata Usaha'),
(18,NULL,'Unit Produksi');
...
(2,'veradf','vera','pera',3),
(3,'Multimedia','dewi','dewa',2),
(5,'Rekayasa Perangkat Lunak','fahr','fmz',2),
(9,'Kesiswaan','kesiswaan','kesiswaan',2),
(12,'Kepala Sekolah','kepsek','kepsek',4),
(14,'Kepala Sekolah','tes2','tes2',4),
(15,'Kurikulum','kurikulum','kurikulum',2),
(16,'pelog','kukuh','pelog',1);
